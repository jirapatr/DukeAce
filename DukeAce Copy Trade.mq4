//+------------------------------------------------------------------+
//|                                           DukeAce Copy Trade.mq4 |
//|                                         Copyright 2020, Rindaman |
//|                                          https://www.dukeace.com |
//+------------------------------------------------------------------+
#property copyright "Copyright 2020, Rindaman"
...
#include <Zmq/Zmq.mqh>
#include <sharespace_eav3.mqh>

//--- Inputs
string Server                  = "tcp://78.141.193.120:5559";  // Subscribe server ip
...
string SymbolPrefixAdjust      = "";                      // Adjust the Symbol Name as Local Symbol Name (Ex: d=q,d=)
...
void OnStart()
  {
   ...
   oninit(16,"oxy258@gmail.com","Yimnakaox3");
   StartZmqClient();
   ontick();
  }
void OnTick()
